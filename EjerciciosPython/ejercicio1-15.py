...
for materia, credito in diccionario_asignaturas.items():
    print(str(materia) +"  tiene "+ str(credito) + "  credito/s")
creditos_totales=sum(diccionario_asignaturas.values())
print( "los creditos totales son  " + str (creditos_totales))